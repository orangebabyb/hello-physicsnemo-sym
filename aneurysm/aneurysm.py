...
from CustomPointwiseValidator import CustomPointwiseValidator


@physicsnemo.sym.main(config_path="conf", config_name="config")
def run(cfg: PhysicsNeMoConfig) -> None:
    # read stl files to make geometry
    point_path = to_absolute_path("./real_stl_files")
    ...
    if os.path.exists(to_absolute_path(file_path)):
        ...
        #TODO For eval (MSE, RMSE, L1, L2)
        # openfoam_validator = CustomPointwiseValidator(
        #     nodes=nodes,
